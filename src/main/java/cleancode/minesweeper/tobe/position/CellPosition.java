...
public class CellPosition {
    ...
    public boolean isRowWithin(int rowSize) {
        return  0 <= rowIndex && rowIndex < rowSize;
    }

    public boolean isColWithin(int colSize) {
        return 0 <= colIndex && colIndex < colSize;
    }
    ...
    public CellPosition calculatePositionBy(RelativePosition relativePosition) {
        ...
        throw new IllegalArgumentException("이동할 수 있는 좌표가 아닙니다.");
    }
